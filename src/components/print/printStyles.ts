...
export function buildPrintCss(config: DocumentTemplateConfig): string {
  ...
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .header-company { display: flex; align-items: flex-start; gap: 8px; max-width: 62%; }
    .header-company img.logo { object-fit: contain; }
    ...
    .doc-meta-table { font-size: 0.82em; border: 1px solid ${general.borderColor}; border-collapse: collapse; }
    ...
    .customer-block { flex: 1.4; border: 1px solid ${general.borderColor}; border-radius: 2px; padding: 6px 10px; font-size: 0.88em; }
    .subject-block { flex: 1; border: 1px solid ${general.borderColor}; border-radius: 2px; padding: 6px 10px; font-size: 0.88em; }
